...
assert selectedDate == '27/11/2023'
WebUI.setText(findTestObject('Object Repository/Make Appointment Repository/Page_Make Appointment/textarea_Comment_comment'), 'Thank you')
WebUI.click(findTestObject('Object Repository/Make Appointment Repository/Page_Make Appointment/button_Book Appointment'))
boolean isValueEntered = WebUI.verifyTextPresent('Visit date invalid', false, FailureHandling.STOP_ON_FAILURE)
if (isValueEntered) {
	println('Book Failed')
} else {
	println('Book Successful')
}
